...
declare class TransactionManager {
     ...
     */
    closeTransactionWithError(id: string, owner: object, error: object): PendingTransaction | void;
    /**
     ...
     * @param {object} error - The error object
     */
    closeAllTransactionsWithError(owner?: object | undefined, error: object): void;
    /**
