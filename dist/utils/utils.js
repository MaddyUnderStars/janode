...
exports.getCliArgument = exports.checkUrl = exports.delayOp = exports.newIterator = exports.getNumericID = exports.randomString = void 0;
/**
...
const getCliArgument = (arg_name, arg_type, arg_default) => {
    ...
    for (const param of args) {
        ...
        /* --arg=value */
            ...
            if (arg_val) {
                if (arg_type === 'boolean') {
                    if (arg_val.toLowerCase() === 'false')
                        arg_val = false;
                    else if (arg_val.toLowerCase() === 'true')
                        arg_val = true;
                    if (typeof arg_val !== 'boolean')
                        arg_val = undefined;
                }
                if (arg_type === 'number') {
                    arg_val = parseInt(arg_val);
                    if (!Number.isInteger(arg_val))
                        arg_val = undefined;
                }
            }
        }
