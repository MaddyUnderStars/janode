 ...
 * @hideconstructor
 */
class StreamingHandle extends handle_js_1.default {
    /**
    ...
    watch({ id, pin, audio, video, data, restart = false }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof audio === 'boolean')
                body.offer_audio = audio;
            if (typeof video === 'boolean')
                body.offer_video = video;
            if (typeof data === 'boolean')
                body.offer_data = data;
    ...
    configure({ audio, video, data, substream, temporal, fallback, spatial_layer, temporal_layer }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof temporal_layer === 'number')
    ...
    createRtpMountpoint({ id = 0, name, description, secret, pin, admin_key, permanent = false, is_private = false, e2ee = false, audio, video, data, threads, metadata }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof audio === 'object' && audio) {
                ...
                if (typeof audio.rtcpport === 'number')
                    body.audiortcpport = audio.rtcppport;
                if (typeof audio.mcast === 'string')
                    body.audiomcast = audio.mcast;
                if (audio.pt)
                    body.audiopt = audio.pt;
                if (audio.rtpmap)
                    body.audiortpmap = audio.rtpmap;
                if (typeof audio.skew === 'boolean')
                    body.audioskew = audio.skew;
            }
            if (typeof video === 'object' && video) {
                body.video = true;
                body.videoport = (typeof video.port === 'number') ? video.port : 0;
                if (typeof video.rtcpport === 'number')
                    body.videortcpport = video.rtcpport;
                if (typeof video.mcast === 'string')
                    body.videomcast = video.mcast;
                if (video.pt)
                    body.videopt = video.pt;
                if (video.rtpmap)
                    body.videortpmap = video.rtpmap;
                if (video.fmtp)
                    body.videofmtp = video.fmtp;
                if (typeof video.buffer === 'boolean')
                    body.videobufferkf = video.buffer;
                if (typeof video.skew === 'boolean')
                    body.videoskew = video.skew;
            ...
            if (typeof data === 'object' && data) {
                ...
                if (typeof data.buffer === 'boolean')
                    body.databuffermsg = data.buffer;
            }
