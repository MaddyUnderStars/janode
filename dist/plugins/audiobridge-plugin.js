 ...
 * @hideconstructor
 */
class AudioBridgeHandle extends handle_js_1.default {
    /**
                ...
                case 'joined':
                    ...
                    /* If the event contains the participants field, this is the join of another peer */
                        ...
                        if (typeof message_data.participants[0].suspended !== 'undefined')
                            janode_event.data.suspended = message_data.participants[0].suspended;
    ...
    join(_a) {
        return __awaiter(this, arguments, void 0, function* ({ room, feed, display, muted, pin, token, quality, volume, record, filename, suspended, pause_events, rtp_participant, group, generate_offer }) {
            ...
            if (typeof pause_events === 'boolean')
                body.pause_events = pause_events;
    ...
    configure(_a) {
        return __awaiter(this, arguments, void 0, function* ({ display, muted, quality, bitrate, volume, record, filename, expected_loss, prebuffer, group, jsep = null }) {
            ...
            if (event === PLUGIN_EVENT.CONFIGURED) {
                ...
                if (typeof body.display !== 'undefined')
                    evtdata.display = body.display;
                if (typeof body.muted !== 'undefined')
                    evtdata.muted = body.muted;
                if (typeof body.quality !== 'undefined')
                    evtdata.quality = body.quality;
                if (typeof body.volume !== 'undefined')
                    evtdata.volume = body.volume;
                if (typeof body.record !== 'undefined')
                    evtdata.record = body.record;
    ...
    create(_a) {
        return __awaiter(this, arguments, void 0, function* ({ room, description, permanent, sampling_rate, bitrate, is_private, secret, pin, admin_key, record, filename, rec_dir, talking_events, talking_level_threshold, talking_packets_threshold, expected_loss, prebuffer, allow_rtp, groups, denoise }) {
            ...
            if (typeof sampling_rate === 'number')
                body.sampling = sampling_rate;
            if (typeof bitrate === 'number')
                body.default_bitrate = bitrate;
            ...
            if (typeof record === 'boolean')
                body.record = record;
            if (typeof filename === 'string')
                body.record_file = filename;
            if (typeof rec_dir === 'string')
                body.record_dir = rec_dir;
            ...
            if (typeof prebuffer === 'number')
                body.default_prebuffering = prebuffer;
            if (typeof allow_rtp === 'boolean')
                body.allow_rtp_participants = allow_rtp;
    ...
    suspend(_a) {
        return __awaiter(this, arguments, void 0, function* ({ room, feed, stop_record, pause_events, secret }) {
            ...
            if (typeof stop_record === 'boolean')
                body.stop_record = stop_record;
            if (typeof pause_events === 'boolean')
                body.pause_events = pause_events;
            if (typeof secret === 'string')
                body.secret = secret;
